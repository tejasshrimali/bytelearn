...
async function main() {
  const response = await ai.models.generateContent({
    ...
    and generate the question and answers for the same inside an array having qna as key , the array is of objects having question and answer as keys. give the output in json form.
